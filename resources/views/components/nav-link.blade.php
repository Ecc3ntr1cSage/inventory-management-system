...
$classes = ($active ?? false)
            ? 'inline-flex items-center gap-2.5 rounded-lg bg-sidebar-primary px-3 py-2 text-sm font-medium text-sidebar-primary-foreground shadow-sm transition duration-200'
