@if (session()->has('message'))
    <div x-cloak
        class="fixed z-50 inset-x-0 top-2 w-fit mx-auto p-[3px] text-white transition rounded-md bg-gradient-to-tr from-teal-400 via-blue-400 to-indigo-400"
        ...
        <div class="p-4 bg-muted rounded">
            ...
            <span class="inline-block mr-8 text-muted-foreground align-middle">
                {{ session('message') }}
            </span>
        </div>
    </div>
