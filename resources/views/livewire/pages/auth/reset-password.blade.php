...
<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-foreground">Set Semula Kata Laluan</h1>
        <p class="mt-1 text-sm text-muted-foreground">Pilih kata laluan baharu untuk akaun anda.</p>
    </div>
